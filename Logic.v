...
Theorem contrapositive : forall (P Q : Prop),
  (P -> Q) -> (~Q -> ~P).
Proof.
  intros P Q. unfold not. intros h1 h2 h3. apply h1 in h3. apply h2 in h3. apply h3.
Qed.
(** [] *)
...
Theorem not_both_true_and_false : forall P : Prop,
  ~ (P /\ ~P).
Proof.
  intros. unfold not. intros h1. destruct h1 as [T1 T2]. apply T2 in T1. apply T1.
Qed.
(** [] *)
...
Proof.
  intros X P Hf. unfold not. intros He. destruct He as [x E]. apply E. apply Hf.
Qed.
(** [] *)
