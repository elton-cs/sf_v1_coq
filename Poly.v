...
Lemma map_distr_over_app : forall (X Y : Type) (f: X -> Y) (l1 l2 : list X), map f (l1 ++ l2) = map f l1 ++ map f l2.
Proof. intros.
...
Proof.
  ...
  induction l as [| h t IHl].
  - simpl. reflexivity.
  - simpl. rewrite <- IHl. rewrite map_distr_over_app. simpl. reflexivity.
Qed. 
